...
describe('impressionTracker', function() {
  ...
  it('tracks when elements are visible in the viewport', function() {
    ...
    browser.scroll('#bar');
    browser.waitUntil(log.hitCountEquals(14));

    hits = log.getHits();
    assert.strictEqual(hits[7].ec, 'Viewport');
    assert.strictEqual(hits[7].ea, 'impression');
    assert.strictEqual(hits[7].el, 'bar');
    assert.strictEqual(hits[8].ec, 'Viewport');
    assert.strictEqual(hits[8].ea, 'impression');
    assert.strictEqual(hits[8].el, 'bar-1');
    assert.strictEqual(hits[9].ec, 'Viewport');
    assert.strictEqual(hits[9].ea, 'impression');
    assert.strictEqual(hits[9].el, 'bar-1-1');
    assert.strictEqual(hits[10].ec, 'Viewport');
    assert.strictEqual(hits[10].ea, 'impression');
    assert.strictEqual(hits[10].el, 'bar-1-2');
    assert.strictEqual(hits[11].ec, 'Viewport');
    assert.strictEqual(hits[11].ea, 'impression');
    assert.strictEqual(hits[11].el, 'bar-2');
    assert.strictEqual(hits[12].ec, 'Viewport');
    assert.strictEqual(hits[12].ea, 'impression');
    assert.strictEqual(hits[12].el, 'bar-2-1');
    assert.strictEqual(hits[13].ec, 'Viewport');
    assert.strictEqual(hits[13].ea, 'impression');
    assert.strictEqual(hits[13].el, 'bar-2-2');
  });
  ...
  it('handles elements being added and removed from the DOM', function() {
    ...
    assert.strictEqual(hits[3].ec, 'Viewport');
    assert.strictEqual(hits[3].ea, 'impression');
    assert.strictEqual(hits[3].el, 'fixture');
    assert.strictEqual(hits[4].ec, 'Viewport');
    assert.strictEqual(hits[4].ea, 'impression');
    assert.strictEqual(hits[4].el, 'fixture-1');
    assert.strictEqual(hits[5].ec, 'Viewport');
    assert.strictEqual(hits[5].ea, 'impression');
    assert.strictEqual(hits[5].el, 'fixture-2');
  ...
  it('supports tracking an element either once or every time', function() {
    ...
    assert.strictEqual(hits[2].ec, 'Viewport');
    assert.strictEqual(hits[2].ea, 'impression');
    assert.strictEqual(hits[2].el, 'bar-1');
    assert.strictEqual(hits[3].ec, 'Viewport');
    assert.strictEqual(hits[3].ea, 'impression');
    assert.strictEqual(hits[3].el, 'bar-2');
